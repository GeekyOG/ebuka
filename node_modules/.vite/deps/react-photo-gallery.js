...
var require_ReactPropTypesSecret = __commonJS({
  "node_modules/react-photo-gallery/node_modules/prop-types/lib/ReactPropTypesSecret.js"(exports, module) {
    "use strict";
...
var require_checkPropTypes = __commonJS({
  "node_modules/react-photo-gallery/node_modules/prop-types/checkPropTypes.js"(exports, module) {
    "use strict";
...
var require_factoryWithTypeCheckers = __commonJS({
  "node_modules/react-photo-gallery/node_modules/prop-types/factoryWithTypeCheckers.js"(exports, module) {
    "use strict";
...
var require_prop_types = __commonJS({
  "node_modules/react-photo-gallery/node_modules/prop-types/index.js"(exports, module) {
    if (true) {
...
var Photo = function Photo2(_ref) {
  var index2 = _ref.index, onClick = _ref.onClick, photo = _ref.photo, margin = _ref.margin, direction = _ref.direction, top2 = _ref.top, left2 = _ref.left, key = _ref.key;
  var imgStyle = {
    margin,
    display: "block"
  };
...
var photoPropType = import_prop_types.default.shape({
  ...
  srcSet: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.array]),
  sizes: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.array])
});
Photo.propTypes = {
  index: import_prop_types.default.number.isRequired,
  onClick: import_prop_types.default.func,
  photo: photoPropType.isRequired,
  margin: import_prop_types.default.number,
...
var computeColumnLayout = function computeColumnLayout2(_ref) {
  var photos = _ref.photos, columns = _ref.columns, containerWidth = _ref.containerWidth, margin = _ref.margin;
  var colWidth = (containerWidth - margin * 2 * columns) / columns;
  ...
  var photosPositioned = photosWithSizes.map(function(photo) {
    var smallestCol = colCurrTopPositions.reduce(function(acc, item, i2) {
    ...
    var tallestCol = colCurrTopPositions.reduce(function(acc, item, i2) {
      acc = item > colCurrTopPositions[acc] ? i2 : acc;
      return acc;
    }, 0);
...
var ratio = function ratio2(_ref) {
...
var buildPrecedentsMap = function buildPrecedentsMap2(graph, startNode, endNode) {
  var precedentsMap = {};
  var visited = {};
...
var getPathFromPrecedentsMap = function getPathFromPrecedentsMap2(precedentsMap, endNode) {
  var nodes = [];
  var n = endNode;
  var precedent;
  while (n) {
...
var findShortestPath = function findShortestPath2(graph, startNode, endNode) {
  var precedentsMap = buildPrecedentsMap(graph, startNode, endNode);
  return getPathFromPrecedentsMap(precedentsMap, endNode);
};
var getCommonHeight = function getCommonHeight2(row, containerWidth, margin) {
...
var cost = function cost2(photos, i, j, width, targetHeight, margin) {
...
var makeGetNeighbors = function makeGetNeighbors2(targetHeight, containerWidth, photos, limitNodeSearch, margin) {
...
var computeRowLayout = function computeRowLayout2(_ref) {
  var containerWidth = _ref.containerWidth, limitNodeSearch = _ref.limitNodeSearch, targetRowHeight = _ref.targetRowHeight, margin = _ref.margin, photos = _ref.photos;
...
var findIdealNodeSearch = function findIdealNodeSearch2(_ref) {
  var targetRowHeight = _ref.targetRowHeight, containerWidth = _ref.containerWidth;
  var rowAR = containerWidth / targetRowHeight;
  return round(rowAR / 1.5) + 8;
};
var Gallery = import_react.default.memo(function Gallery2(_ref) {
  var photos = _ref.photos, onClick = _ref.onClick, direction = _ref.direction, margin = _ref.margin, limitNodeSearch = _ref.limitNodeSearch, targetRowHeight = _ref.targetRowHeight, columns = _ref.columns, renderImage = _ref.renderImage;
  var _useState = (0, import_react.useState)(0), _useState2 = _slicedToArray(_useState, 2), containerWidth = _useState2[0], setContainerWidth = _useState2[1];
  var galleryEl = (0, import_react.useRef)(null);
  (0, import_react.useLayoutEffect)(function() {
    var animationFrameID = null;
    var observer = new ResizeObserver_es_default(function(entries) {
  ...
  var handleClick = function handleClick2(event, _ref2) {
  ...
  if (!containerWidth) return import_react.default.createElement("div", {
    ref: galleryEl
  }, " ");
  ...
  return import_react.default.createElement("div", {
    ...
    ref: galleryEl,
    style: galleryStyle
  }, thumbs.map(function(thumb, index2) {
    var left2 = thumb.left, top2 = thumb.top, containerHeight = thumb.containerHeight, photo = _objectWithoutProperties(thumb, ["left", "top", "containerHeight"]);
...
Gallery.propTypes = {
  photos: import_prop_types.default.arrayOf(photoPropType).isRequired,
  direction: import_prop_types.default.string,
  onClick: import_prop_types.default.func,
  columns: import_prop_types.default.oneOfType([import_prop_types.default.func, import_prop_types.default.number]),
  targetRowHeight: import_prop_types.default.oneOfType([import_prop_types.default.func, import_prop_types.default.number]),
  limitNodeSearch: import_prop_types.default.oneOfType([import_prop_types.default.func, import_prop_types.default.number]),
  margin: import_prop_types.default.number,
  renderImage: import_prop_types.default.func
};
...
var react_photo_gallery_esm_default = Gallery;
export {
  Photo,
  react_photo_gallery_esm_default as default
};
//# sourceMappingURL=react-photo-gallery.js.map
